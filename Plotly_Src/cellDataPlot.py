...
class selectedBatteryDataLines(Enum):
    LOWER = 0
    UPPER = 50000
    ##UPPER = 5530  # Set for 28-04-2023 Discharge SoH capacity
...
class cellDataPlotting:
    ...
    def plotBatteryDataStateofHealthCapacityDischargeVoltage(self):
        """Plot multiple battery data"""
        batteryData = self.prepareDataSet()
        ...
        for batteryNumber in range(14):
            fig.add_trace(go.Scatter(x=batteryData['Time(s)'], y=batteryData['cellVoltage_' + str(batteryNumber + 1)],
                                     mode='lines',
                                     name='cellVoltage_' + str(batteryNumber + 1)), secondary_y=False)

        fig.add_trace(go.Scatter(x=batteryData['Time(s)'], y=batteryData['packCurrent'],
                                 mode='lines',
                                 name='packCurrent'),  secondary_y = True)
        ...
        fig.update_yaxes(title_text = "Voltage (mV)", secondary_y = False)
    ...
    def plotBatteryDataStateofHealthCapacity(self):
        ...
        newNames = {
            ...
            'cellSoH_1': 'Cell 1', 'cellSoH_2': 'Cell 2', 'cellSoH_3': 'Cell 3', 'cellSoH_4': 'Cell 4', 'cellSoH_5': 'Cell 5',
            'cellSoH_6': 'Cell 6', 'cellSoH_7': 'Cell 7', 'cellSoH_8': 'Cell 8', 'cellSoH_9': 'Cell 9', 'cellSoH_10': 'Cell 10',
            'cellSoH_11': 'Cell 11', 'cellSoH_12': 'Cell 12', 'cellSoH_13': 'Cell 13', 'cellSoH_14': 'Cell 14',
...
if __name__ == "__main__":
    ...
    # Lithium-ion data
    # Cell balancing
    lithiumBatteryData, lithiumTrendData = cellDataPlotting("Data\\BAK_29_NMC\\13-04-2023\\Balancing", "Data\\PowerSupply\\13-4-2023.csv", 2.9, 'cellCB_2').plotCBControlData()

    # SoC estimation validation for Discharging
    cellDataPlotting("Data\\BAK_29_NMC\\14-04-2023\\Discharging", "Data\\PowerSupply\\13-4-2023.csv", 2.9, 'cellCB_2').plotBatteryDataDischarge("Data\\BAK_29_NMC\\14-04-2023\\SoCData\\dischargeData.jpg")

    # EFC based SoH estimation validation
    ...
    # Capacity based SoH estimation for charging
    ...
    # Capacity based SoH estimation for discharging
    ...
    cellDataPlotting("Data\\BAK_29_NMC\\28-04-2023\\Discharging", "Data\\PowerSupply\\21-4-2023.csv", 2.9, 'cellCB_2').plotBatteryDataStateofHealthCapacityDischargeVoltage()
