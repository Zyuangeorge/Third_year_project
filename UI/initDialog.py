...
class Ui_InitValueDialog(object):
    ...
    def retranslateUi(self, InitValueDialog):
        ...
        self.initVoltageMiniLineEdit.setText(QCoreApplication.translate("InitValueDialog", u"2800", None))
        self.initVoltageMiniLineEdit.setPlaceholderText(QCoreApplication.translate("InitValueDialog", u"Default value 2800mV", None))
        self.initVoltageMaxLabel.setText(QCoreApplication.translate("InitValueDialog", u"Maximum:", None))
        self.initVoltageMaxLineEdit.setText(QCoreApplication.translate("InitValueDialog", u"4200", None))
        self.initVoltageMaxLineEdit.setPlaceholderText(QCoreApplication.translate("InitValueDialog", u"Default value 4200mV", None))
